<template>
  <div class="features-why container-fluid">
    ...
    <div class="features-showcase">
      ...
      <div class="carousel slide showcase-carousel" id="showcase-carousel" data-ride="carousel">
        <img src="../assets/images/editor-frame.png" alt="" class="showcase-frame">
        <div class="carousel-inner showcase-items" id="showcase-items">
          ...
          <div class="left carousel-control-prev arrow-left" href="#showcase-items" data-slide="prev"></div>
          <div class="right carousel-control-next arrow-right" href="#showcase-items" data-slide="next"></div>
        </div>
  ...
  <main>
    ...
    <div class="feature-ready">
      ...
      <div class="download">
        <a href="https://godotengine.org/download/windows/"><DownloadButton hint="4.1.2">Download Latest</DownloadButton></a>
      </div>
      <p>Want to stick to the <strong>true and trusted Godot 3</strong> ? Download the long-term support version!</p>
      <div class="download">
        <a href="https://godotengine.org/download/windows/"><DownloadButton hint="3.5.3" :default-color="false" >&nbsp;&nbsp;Download LTS&nbsp;&nbsp;</DownloadButton></a>
      </div>
    </div>
  </main>
</template>
...
.features-choice {
  ...
  background-color: rgb(51, 63, 103);
}
...
.choice-img img {
  max-width: 100%;
  background-color: hsla(206, 58%, 50%, 0.3);
  box-shadow: 0 5px 10px -3px #00000078;
  border-radius: 7px;
  display: block;
}

.choice-img img:hover {
  filter: brightness(117.5%);
}
